...
func (r *DrinkPostgres) GetDrinks(userID int64) ([]*entities.Drink, error) {
	drinksQuery := `
        SELECT drink_id, name, image, description, compound, is_cold, is_hot
        FROM drink;
    `
...
func (r *DrinkPostgres) ToggleFavorite(drinkID int64, userID int64) error {
...
func (r *DrinkPostgres) GetFavoriteStatus(drinkID, userID int64) (bool, error) {
